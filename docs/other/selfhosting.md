---
title: Selfhosting WORKWATCH
description: This guide will help you set up and run your own instance of WORKWATCH locally.
---

# Selfhosting

:::warning
Do note that you **must** differentiate your instance from the official site (workwatch.net) to avoid confusion. Steps to do so are given in step 4.
:::

This guide will help you set up and run your own instance of WORKWATCH locally.
...
```bash
git clone https://github.com/workwatch/edit.git
cd edit
...
1. Fork the repository and clone it to your local machine with `git clone https://github.com/workwatch/edit.git`.
...
- `WORKWATCH_BUILD_NSFW` - Enable NSFW sidebar entry (experimental)
- `WORKWATCH_BUILD_API` - Enable API component for feedback system
...
You should be able to use any reverse proxy with this vitepress website, but find a reasonable config for an nginx server [in the repo here](https://github.com/workwatch/edit/blob/main/.github/assets/nginx.conf)