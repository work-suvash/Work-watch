...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message:
        `<div class="ww-footer-row">` +
        `<span class="ww-footer-left">Made by <strong>WorkWatch</strong></span>` +
        `<span class="ww-footer-center">This site does not host any files.</span>` +
        `<span class="ww-footer-right">© ${new Date().getFullYear()}</span>` +
        `</div>`,
      copyright: ''
    },
    editLink: {
      pattern: 'https://github.com/workwatch/edit/edit/main/docs/:path',
      text: '📝 Edit this page'
    },
    outline: 'deep',
    logo: {
