...
- Our official pastebin, **[snowbin](https://pastes.workwatch.net/)**, is now live!
...
- Grammar issues have been fixed
  [throughout the wiki](https://github.com/workwatch/WORKWATCHedit/pull/1337) /
  [2](https://github.com/workwatch/WORKWATCHedit/pull/1340) /
  [3](https://github.com/workwatch/WORKWATCHedit/pull/1339). Remember that anyone can send
  [pull requests](https://github.com/workwatch/WORKWATCHedit) to our GitHub, so don't be
  afraid to help us fix things like this.

- Added a mirror of our site to [github.io](https://workwatch.github.io/WORKWATCHedit/).
...
- Starred [CRACKSurl](/downloading#software-sites) in Software Sites.
  Clean scans + admins are members of WORKWATCH.
