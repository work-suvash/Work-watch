...
- [Install F-Droid](https://f-droid.org/) on your Android device(s) (or similar [FOSS installers](https://workwatch.pages.dev/mobile#foss-apks)). The more people that use alternative app marketplaces, the harder it will be to shut them out.
